...
export const CANONICAL_WORD_DETAIL = {
  ...
  lemma: "rollback",
  translation: "откат",
  aliases: ["roll back", "cross-region-disaster-recovery-rollback"],
...
export const CANONICAL_RELATED_PHRASES = [
  ...
  },
  {
    id: 303,
    kind: "phrase" as const,
    slug: "coordinate-a-cross-region-rollback-window",
    lemma: "Coordinate a cross-region rollback window",
    translation: "Согласовать межрегиональное окно отката",
    phonetic: "",
    partOfSpeech: "phrase",
    topic: "Release",
    examples: ["Coordinate a cross-region rollback window with the release manager."],
