...
4. [`AGENTS.issue-19-completion.md`](./AGENTS.issue-19-completion.md) — обязательное правило сквозного consumer audit для новых API fields и acceptance criteria.

Все документы обязательны и применяются совместно. При расхождении более конкретное правило из дополнений имеет приоритет для соответствующего product slice, route island, accessibility contract, reduced motion, direct-detail mocks, Linux visual artifacts, progressive disclosure и temporary workflow lifecycle.
