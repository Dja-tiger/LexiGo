...
The catalog is loaded only while the Dictionary view is active; home, progress and lesson screens do not start background dictionary requests. Result cards expose global positions to assistive technology, and both pagination controls remain keyboard accessible.
